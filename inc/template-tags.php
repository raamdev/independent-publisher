		...
		function independent_publisher_sharing_buttons()
			{
				...
				<div class="social-buttons">
					<a target="_new" href="https://twitter.com/share?text=<?php echo $clean_title; ?>&url=<?php the_permalink(); ?>" title="Share '<?php echo $clean_title; ?>' on Twitter" onclick="share_button_popup(this.href); return false;"><i class="icon-twitter"></i></a>
