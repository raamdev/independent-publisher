...
<article id="post-<?php the_ID(); ?>" <?php independent_publisher_post_classes(); ?>>
	...
	<div class="entry-content">
		...
		<?php /* Only show excerpts for Standard format, non-Sticky posts,
		...
		<?php if ( ! get_post_format() && ! is_sticky() &&
				...
				( ! ( independent_publisher_show_full_content_first_post() && independent_publisher_is_very_first_standard_post() ) )
		) :
			?>
